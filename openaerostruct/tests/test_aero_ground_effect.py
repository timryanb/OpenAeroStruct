...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        prob.model.add_subsystem(point_name, aero_group,
            promotes_inputs=['v', 'alpha', 'Mach_number', 're', 'rho', 'cg', 'height_agl'])
        ...
        prob.model.add_design_var('height_agl', lower=10., upper=8000.)
        ...
        totals = prob.check_totals(of=['aero_point_0.wing_perf.CD','aero_point_0.wing_perf.CL'], wrt=['wing.twist_cp','height_agl'],compact_print=True, out_stream=None)
