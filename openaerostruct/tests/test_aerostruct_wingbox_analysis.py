...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        assert_rel_error(self, prob['AS_point_0.fuelburn'][0], 89411.50246542075, 1e-5)
        assert_rel_error(self, prob['wing.structural_mass'][0]/1.25, 24009.5230566, 1e-5)
        assert_rel_error(self, prob['AS_point_0.wing_perf.failure'][0], 1.6254327137382174, 1e-5)
